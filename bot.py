...
PULLBACK_MIN_DIP_PERCENT = 30       # ย่อจากยอดที่จำไว้อย่างน้อยเท่านี้ จึงรอเด้งเข้าซื้อ
PULLBACK_MAX_DIP_PERCENT = 45       # ย่อลึกกว่านี้ = โครงสร้างพัง ล้างยอด เริ่มใหม่
