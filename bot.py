...
PULLBACK_MIN_DIP_PERCENT = 3       # ย่อจากยอดที่จำไว้อย่างน้อยเท่านี้ จึงรอเด้งเข้าซื้อ
PULLBACK_MAX_DIP_PERCENT = 4.5       # ย่อลึกกว่านี้ = โครงสร้างพัง ล้างยอด เริ่มใหม่
PULLBACK_BOUNCE_PERCENT = 1       # เด้งจากจุดต่ำของย่ออย่างน้อยเท่านี้ถึงซื้อ (กันมีดตก)
