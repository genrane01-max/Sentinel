...
GRADUAL_MIN_BUCKET_PERCENT = 0.3    # นับเป็น "ขยับขึ้น" ถ้าช่วงนั้นขึ้นอย่างน้อยเท่านี้
GRADUAL_MAX_BUCKET_PERCENT = 0.7       # ช่วงไหนขึ้น/ลงแรงเกินนี้ = ไม่ใช่ขยับทีละนิดแล้ว
